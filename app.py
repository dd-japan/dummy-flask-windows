...
def nested_simple():
    ...
    return jsonify({'type': 'simple_nested', 'operations': ['parent', 'child1', 'child2'], 'total_delay_ms': 250})


@app.route('/nested/complex')
def nested_complex():
    """Complex nested operations with multiple levels."""
    # Level 1
    time.sleep(0.05)
...
def nested_database():
    ...
    return jsonify({'type': 'database_simulation', 'operations': results, 'query_count': 3})
